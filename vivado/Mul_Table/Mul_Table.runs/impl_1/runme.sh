...
HD_PWD='E:/vivado/Mul_Table/Mul_Table.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mult_Top.tcl -notrace
