...
HD_PWD='E:/vivado/Mul_Table/Mul_Table.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult_Top.tcl
