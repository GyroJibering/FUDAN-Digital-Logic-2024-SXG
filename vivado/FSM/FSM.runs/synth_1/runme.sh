...
HD_PWD='C:/2023Sam/Vivado2022/Codes/FSM/FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DetectSequence_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DetectSequence_Top.tcl
