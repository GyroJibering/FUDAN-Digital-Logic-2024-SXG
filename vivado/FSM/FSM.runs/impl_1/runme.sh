...
HD_PWD='C:/2023Sam/Vivado2022/Codes/FSM/FSM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DetectSequence_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DetectSequence_Top.tcl -notrace
