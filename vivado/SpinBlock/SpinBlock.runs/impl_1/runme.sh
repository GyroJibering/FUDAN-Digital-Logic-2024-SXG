...
HD_PWD='E:/vivado/SpinBlock/SpinBlock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SpinBlock_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SpinBlock_Top.tcl -notrace
