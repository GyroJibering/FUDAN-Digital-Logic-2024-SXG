...
HD_PWD='E:/vivado/SpinBlock/SpinBlock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpinBlock_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpinBlock_Top.tcl
