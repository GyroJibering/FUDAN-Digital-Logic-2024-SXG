...
HD_PWD='E:/vivado/stopwatch/stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_Top.tcl
