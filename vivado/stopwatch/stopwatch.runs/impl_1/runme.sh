...
HD_PWD='E:/vivado/stopwatch/stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_Top.tcl -notrace
