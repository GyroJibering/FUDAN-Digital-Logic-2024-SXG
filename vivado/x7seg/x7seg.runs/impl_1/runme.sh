...
HD_PWD='E:/vivado/x7seg/x7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log x7seg_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source x7seg_Top.tcl -notrace
