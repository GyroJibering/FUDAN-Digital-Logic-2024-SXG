...
HD_PWD='E:/vivado/x7seg/x7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log x7seg_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source x7seg_Top.tcl
