...
HD_PWD='E:/vivado/RedBlueLight/RedBlueLight.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DualColorWarningLight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DualColorWarningLight.tcl -notrace
