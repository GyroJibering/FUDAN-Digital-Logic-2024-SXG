...
HD_PWD='E:/vivado/RedBlueLight/RedBlueLight.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DualColorWarningLight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DualColorWarningLight.tcl
