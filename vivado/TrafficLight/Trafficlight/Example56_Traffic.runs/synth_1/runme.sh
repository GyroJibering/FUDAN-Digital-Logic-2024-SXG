...
HD_PWD='E:/vivado/Example56_Traffic/Example56_Traffic/Example56_Traffic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Traffic_Top.tcl
