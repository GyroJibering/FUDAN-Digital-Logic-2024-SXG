...
HD_PWD='E:/vivado/Example56_Traffic/Example56_Traffic/Example56_Traffic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Traffic_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Traffic_Top.tcl -notrace
