...
HD_PWD='C:/2023Sam/Vivado2022/Codes/ping-pongText/ping-pong.runs/Fudan320x320_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fudan320x320.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fudan320x320.tcl
