...
HD_PWD='C:/2023Sam/Vivado2022/Codes/ping-pongText/ping-pong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpong_text_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pingpong_text_Top.tcl
