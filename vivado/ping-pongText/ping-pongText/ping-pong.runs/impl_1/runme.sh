...
HD_PWD='C:/2023Sam/Vivado2022/Codes/ping-pongText/ping-pong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpong_text_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pingpong_text_Top.tcl -notrace
