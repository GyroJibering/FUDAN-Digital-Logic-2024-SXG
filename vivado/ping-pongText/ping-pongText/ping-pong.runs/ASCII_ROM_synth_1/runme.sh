...
HD_PWD='C:/2023Sam/Vivado2022/Codes/ping-pongText/ping-pong.runs/ASCII_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASCII_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASCII_ROM.tcl
