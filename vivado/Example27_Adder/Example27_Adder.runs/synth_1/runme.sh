...
HD_PWD='C:/Users/Sam/Documents/Vivado2015/Example27_Adder/Example27_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4a.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Adder4a.tcl
