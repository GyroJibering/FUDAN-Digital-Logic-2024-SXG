...
HD_PWD='E:/vivado/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log locker_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source locker_top.tcl -notrace
