...
HD_PWD='E:/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log locker_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source locker_top.tcl
