...
HD_PWD='E:/vivado/EscapeGame/EscapeGame.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Escape_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Escape_Top.tcl
