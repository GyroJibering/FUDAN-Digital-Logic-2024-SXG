...
HD_PWD='E:/vivado/EscapeGame/EscapeGame.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Escape_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Escape_Top.tcl -notrace
