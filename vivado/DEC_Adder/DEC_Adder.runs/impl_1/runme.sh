...
HD_PWD='E:/vivado/DEC_Adder/DEC_Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DEC_Adder_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DEC_Adder_Top.tcl -notrace
