...
HD_PWD='E:/vivado/DEC_Adder/DEC_Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEC_Adder_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEC_Adder_Top.tcl
