...
HD_PWD='E:/vivado/pic/pic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PicMusic_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PicMusic_Top.tcl -notrace
