...
HD_PWD='E:/vivado/pic/pic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PicMusic_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PicMusic_Top.tcl
