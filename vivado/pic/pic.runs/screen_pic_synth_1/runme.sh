...
HD_PWD='E:/vivado/pic/pic.runs/screen_pic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log screen_pic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source screen_pic.tcl
