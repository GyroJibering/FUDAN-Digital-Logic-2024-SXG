...
#
# Generated by export_simulation on Sat Dec 07 22:49:31 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Pixel.sh' script.
...
./Pixel.sh -noclean_files

For more information on the script, please type './Pixel.sh -help'.
