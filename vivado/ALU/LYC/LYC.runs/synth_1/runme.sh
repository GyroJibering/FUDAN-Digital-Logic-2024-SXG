...
HD_PWD='E:/vivado/ALU/LYC/LYC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lead2_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lead2_Top.tcl
