...
HD_PWD='E:/vivado/ALU/LYC/LYC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lead2_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lead2_Top.tcl -notrace
