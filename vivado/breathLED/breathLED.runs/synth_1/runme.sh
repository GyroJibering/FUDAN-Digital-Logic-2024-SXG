...
HD_PWD='C:/_SamData/Vivado2022/Codes/breathLED/breathLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log breathLED_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source breathLED_Top.tcl
