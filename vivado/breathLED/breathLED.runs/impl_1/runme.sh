...
HD_PWD='C:/_SamData/Vivado2022/Codes/breathLED/breathLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log breathLED_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source breathLED_Top.tcl -notrace
