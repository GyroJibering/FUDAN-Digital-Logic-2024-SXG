...
HD_PWD='E:/vivado/ping-pong/ping-pong.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpong_screen_pic_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pingpong_screen_pic_Top.tcl -notrace
