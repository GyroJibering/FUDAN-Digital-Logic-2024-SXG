...
HD_PWD='E:/vivado/ping-pong/ping-pong.runs/SuperMario_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SuperMario.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SuperMario.tcl
