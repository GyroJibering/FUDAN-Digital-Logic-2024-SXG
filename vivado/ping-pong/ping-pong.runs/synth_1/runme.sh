...
HD_PWD='E:/vivado/ping-pong/ping-pong.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pingpong_screen_pic_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pingpong_screen_pic_Top.tcl
