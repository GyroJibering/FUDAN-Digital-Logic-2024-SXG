...
HD_PWD='E:/vivado/Bin2Gray/Bin2Gray.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bin2Gray_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bin2Gray_2.tcl -notrace
