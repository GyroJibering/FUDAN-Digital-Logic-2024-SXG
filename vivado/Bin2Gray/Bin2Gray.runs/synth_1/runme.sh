...
HD_PWD='E:/vivado/Bin2Gray/Bin2Gray.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bin2Gray_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bin2Gray_2.tcl
