...
HD_PWD='E:/vivado/DualFlashingLights/DualFlashingLights.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DualFlashingLights.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DualFlashingLights.tcl
