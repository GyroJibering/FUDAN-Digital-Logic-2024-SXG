...
HD_PWD='E:/vivado/DualFlashingLights/DualFlashingLights.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DualFlashingLights.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DualFlashingLights.tcl -notrace
