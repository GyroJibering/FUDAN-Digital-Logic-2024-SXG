...
HD_PWD='E:/vivado/FlipFlop/FlipFlop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_cs2_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_cs2_Top.tcl -notrace
