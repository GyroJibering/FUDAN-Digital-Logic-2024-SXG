...
HD_PWD='E:/vivado/FlipFlop/FlipFlop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_cs2_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_cs2_Top.tcl
