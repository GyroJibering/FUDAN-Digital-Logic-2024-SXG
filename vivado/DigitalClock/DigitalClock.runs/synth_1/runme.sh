...
HD_PWD='E:/vivado/DigitalClock/DigitalClock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clock_Top.tcl
