...
HD_PWD='E:/vivado/DigitalClock/DigitalClock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Clock_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Clock_Top.tcl -notrace
