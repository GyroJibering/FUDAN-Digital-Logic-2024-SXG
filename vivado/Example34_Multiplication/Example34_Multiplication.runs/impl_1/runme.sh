...
HD_PWD='C:/_SamData/Vivado2022/Codes/Example34_Multiplication/Example34_Multiplication.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult4_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mult4_Top.tcl -notrace
