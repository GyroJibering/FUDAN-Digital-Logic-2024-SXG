...
HD_PWD='C:/_SamData/Vivado2022/Codes/Example34_Multiplication/Example34_Multiplication.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mult4_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mult4_Top.tcl
